...
- (id)init {
	if (self==[super init]) {
        ...
        self.shareModel.Annotations = [[NSMutableArray alloc] init];
        self.shareModel.VenueAnnotations = [[NSMutableArray alloc] init];
...
- (void)startLocationTracking {
	...
	if ([CLLocationManager locationServicesEnabled] == NO) {
		...
		UIAlertView *servicesDisabledAlert = [[UIAlertView alloc] initWithTitle:@"Location Services Disabled" message:@"You wont be able to find your friends or find parties until you turn on location services. Go to Settings -> Privacy -> Location Services to turn them on." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
   ...
   // NSLog(@"locationManager error:%@",error);
    ...
    switch([error code])
    {
        case kCLErrorNetwork: // general, network-related error
        {
            ...
            break;
        case kCLErrorDenied:{
            UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Location Services" message:@"You need to enable Location Service to use the primary functions of this App. To enable, please go to Settings -> Privacy -> Location Services" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
            [alert show];
        }
            break;
        default:
...
- (void)updateLocationToServer {
    ...
    if ([PFUser currentUser]) {
        ...
        [PFGeoPoint geoPointWithLatitude:self.myLocation.latitude
